...
<?php include '../../MKCMS5.0/moban/mkcms/header.php'; ?>
<div class="container">
...
<iframe id="iframe-player" name="iframe-player" src="../../MKCMS5.0/moban/music" width="100%" height="500" scrolling="no" frameborder="0"></iframe>
</div>
</div>
	</div>
</div></div>
<?php  include '../../MKCMS5.0/moban/mkcms/footer.php';?>