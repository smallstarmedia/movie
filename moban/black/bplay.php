...
<script type="text/javascript"> 
    ...
    //设置延时函数
    function adsUp(){    
        $("#shiping_box").html('<iframe allowFullscreen="true" src="<?php echo $mkcms_domain;?>jx/jx.php?url=<?php $result = mysqli_query($conn,'select * from mkcms_vod where d_id ='.$d_id.'');
		...
		<div class="col-md-3 col-sm-12 hy-main-side hidden-sm hidden-xs">
			<div class="hy-layout clearfix">
				...
				<div class="hy-video-ranking side clearfix">
					<div class="head">
						<a class="text-muted pull-right" href="<?php echo $mkcms_domain;?>vlist.php?cid=0">更多 <i class="icon iconfont icon-xiangyou"></i></a>
						<h4><i class="icon iconfont icon-top text-color"></i> 抢先看资源</h4>
					</div>
					<div class="item">
						<ul class="clearfix">
						<?php $result = mysqli_query($conn,'select * from mkcms_vod order by d_id desc LIMIT 0,12');
