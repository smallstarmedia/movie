...
<?php 
	...
	$result = mysqli_query($conn,'select * from mkcms_vod where d_name like "%'.$q.'%" order by d_id desc');
...
?>
		 <li class ="activeclearfix">
		  ...
		  <div class="detail">
           <h3 class="title"><a href="<?php echo $chuandi?><?php echo $html?>"><?php echo $cs?></a></h3>
