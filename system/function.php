...
function channel_manage($_var_32, $_var_33)
{
	...
	$_var_35 = $_var_33;
	$_var_36 = '';
	$_var_37 = mysqli_query($conn,'select * from mkcms_vod_class where c_pid= ' . $_var_32 . ' order by c_sort asc , c_id asc ');
...
{
	$_var_42 = mysqli_query($conn,'select * from mkcms_vod_class where c_id=' . $_var_41 . '');
...
{
	$_var_48 = mysqli_query($conn,'select * from mkcms_vod where d_id =' . $_var_47 . '');
...
{
	$_var_51 = mysqli_query($conn,'select * from mkcms_vod where d_id =' . $_var_50 . '');
...
{
	$_var_56 = mysqli_query($conn,'select * from mkcms_vod where d_id =' . $_var_55 . '');
